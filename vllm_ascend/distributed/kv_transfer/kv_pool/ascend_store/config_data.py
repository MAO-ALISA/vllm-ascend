...
def resolve_hybrid_cache_c128_config(
    ...
    *,
    ...
    if extra_config.get("load_async", False):
        raise ValueError(f"{config_key} currently requires load_async=false.")
...
class ChunkedTokenDatabase:
    ...
    def prepare_transfer_value(
        ...
        if self.is_c128_group(kv_cache_group_id):
            ...
            # authoritative slot range identifies the prefix represented by
            # that page snapshot; loading writes the selected snapshot
            # directly into its target page.
            value_start = 0
